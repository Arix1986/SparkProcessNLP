...
class TextCleaner:
    def __init__(self, spark,expand_contractions=True):
        ...
        self.pipelin_general_path = "./models/pipelines/pipeline_general"
        self.pipelin_w2v_path = "./models/pipelines/pipeline_w2v"
    ...
    def clean_dataframe(self, df):
      self.bert_embedder = BertSentenceEmbeddings.load("./models/sent_small_bert_L8_512") \
            .setInputCols(["document"]) \
